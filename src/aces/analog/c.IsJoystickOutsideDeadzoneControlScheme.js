export const config = {
  ...
  displayText: "Is joystick [i]{0}[/i] outside deadzone for player [i]{1}[/i] and control scheme [i]{2}[/i]",
  description: "Test if a joystick is outside its deadzone for a control scheme",
  params: [
...
export default function (name, player, scheme) {
  return this._IsJoystickOutsideDeadzoneControlScheme(name, player, scheme);
}
