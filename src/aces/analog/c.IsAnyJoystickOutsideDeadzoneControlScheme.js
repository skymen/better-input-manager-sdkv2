export const config = {
  ...
  displayText: "Is any joystick outside deadzone for player [i]{0}[/i] and control scheme [i]{1}[/i]",
  description: "Test if any joystick is outside its deadzone for a control scheme",
  params: [
...
export default function (player, scheme) {
  return this._IsAnyJoystickOutsideDeadzoneControlScheme(player, scheme);
}
